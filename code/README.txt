Minimal MPD Client - v0.8.1

This is a 'huge leap forward' release in terms of my ultimate goals.
    v0.8.1 catches a previously unseen error.
...
- The 'Play a Single' window has a couple of mini-console functions.
- Options added to Tools for toggling repeat, consume and single modes.